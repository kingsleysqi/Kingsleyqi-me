...
Me.Kingsleyqi.com 是一个以 **个人表达、身份展示与内容沉淀** 为核心的独立网站项目。
...
| Media.* | 媒体内容 / 资源 |
| Me.Kingsleyqi.com | 个人状态 / 自我表达 / 内在空间 |

👉 `me.kingsleyqi.com` 更偏向 **“我是谁，而不是我做了什么”**
...
```text
        ...
        │                    │                    │
┌───────────────┐   ┌────────────────────────┐   ┌────────────────────┐
│ Kingsleyqi.cn │   │ Me.Kingsleyqi.com      │   │ Media.*            │
│ 中文表达      │   │ 自我表达 / 内在空间     │   │ 媒体 / 资源分发     │
└───────────────┘   └────────────────────────┘   └────────────────────┘
